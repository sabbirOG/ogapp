...
function App() {
  ...
  const resetData = () => {
    ...
    setTasks([]); setHabits([]); setExpenses([]); setNotes([]); setGoals([]); setReports([]); setActivity([]); setSettings(empty.settings); notify('All local data deleted')
  }
  const runCommand = () => {

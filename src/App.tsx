...
function Today({ tasks, habits, expenses, walking, onEnableWalking, notifications, onEnableNotifications, completed, spent, currency, name, dateLabel, clockLabel, prayers, prayerError, formatPrayerTime, command, setCommand, onCommand, onTask, onHabit, onAdd, onNavigate, onDelete }: { tasks: Task[]; habits: Habit[]; expenses: Expense[]; walking: StepCounterStatus | null; onEnableWalking: () => void; notifications: boolean; onEnableNotifications: () => void; completed: number; spent: number; currency: string; name: string; dateLabel: string; clockLabel: string; prayers: PrayerSchedule | null; prayerError: string; formatPrayerTime: (value: string) => string; command: string; setCommand: (value: string) => void; onCommand: () => void; onTask: (id: number) => void; onHabit: (id: number) => void; onAdd: (type: string) => void; onNavigate: (page: string) => void; onDelete: (type: string, id: number) => void }) {
